# this will ingest the data from the url itself
import os
import sys
...
# we are still using modular coding


class DataIngestion:
    def _init_(self, app_config = AppConfiguration()):
        """
    ...
    # we can extract our zip file once we have downloaded
    ...
    # will call the download and extract functions
